.TH man 1 "15 May 2022" "0.1" "simple_shell man page"
...
.SH DESCRIPTION
Simple_Shell is an sh-compatible command language interpreter that executes
...
.SH AUTHOR
Alfred Emmanuel and Solomon Tetteh
